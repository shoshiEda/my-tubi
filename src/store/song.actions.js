...
import { ADD_REVIEW, REMOVE_REVIEW, SET_REVIEWS , SET_SELECTED_SONG } from './song.reducer.js'
import { SET_SCORE, SET_WATCHED_USER } from './user.reducer.js'

// Action Creators

export function setSelectedSong(input)
{
  return { type: SET_SELECTED_SONG, input }
}
